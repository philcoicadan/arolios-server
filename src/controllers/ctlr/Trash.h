...
class Trash:public drogon::HttpController<Trash>
{
  public:
    ...
    ADD_METHOD_TO(ctlr::Trash::list_instances, "/trash?o={1}&l={2}&s={3}&d={4}&f={5}&lang={6}", drogon::Get , "arolios::filter::Login", arolios::filter::RAC_util::Author());
 
    ADD_METHOD_TO(ctlr::Nothing::options_1, "/trash/{1}", Options, "arolios::filter::Patch_delete_option");    
    ADD_METHOD_TO(ctlr::Trash::recover_instance, "/trash/{1}", drogon::Patch , "arolios::filter::Login", arolios::filter::RAC_util::Author());
